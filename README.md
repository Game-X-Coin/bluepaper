...
GXC는 정해진 Inflation양에 따라 지속적으로 발행되며, 이 발행된 양은 네트워크 관계자들에게 분배된다. 최초의 Inflation율은 연간 5%정도로 설정되며 이 Inflation율은 BP들의 논의를 통해 조절될 수 있다. 5%의 Inflation은 BP보상, Voting 보상, Gaming 보상, Work Proposal 보상으로 나누어서 분배되며 보상률은 각각 1%, 1%, 2%, 1%로 초기 설정된다.
